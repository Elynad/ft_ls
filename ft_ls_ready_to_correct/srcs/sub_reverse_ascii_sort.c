...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/07 11:43:22 by mameyer           #+#    #+#             */
/*   Updated: 2017/07/11 17:26:11 by mameyer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		sub_reverse_ascii_sort_1(t_lst *lst, char *name, char *path,
		struct stat sb)
{
	t_lst		*new;

	if (sub_rev_ascii_conds(lst, sb, name) == 1)
		sub_next_1(lst, name, path);
	else if (sub_rev_ascii_conds(lst, sb, name) == 2)
	{
	...
	else if (sub_rev_ascii_conds(lst, sb, name) == 3)
	{
