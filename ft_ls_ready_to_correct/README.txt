...
(resolu)			- Si on fait ft_ls empty_directory, le programme affiche le
...
(resolu)			- Un ls -l sur un simple fichier ne l'affiche pas en format
					long

(resolu)			- Segfault sur le ls -R fichier_simple

(resolu)			- Un ls -l sur un simple fichier affiche le total
					=> L'affichage du total est reserve aux -l sur dossiers

(resolu)			- Un ls -l sur un dossier sans les droits n'affiche pas le
					bon message d'erreur

(resolu)			- Le "total" en cas de -l ne donne pas le meme nombre que le
					vrai ls
________________________
          A FAIRE
________________________
...
- Gerer l'affichage des liens symboliques
		///// DONE /////
